        ...
        {isLoggedIn ? (
          <>
            ...
            <BentoCard
              icon={Activity}
              title="Key Verlauf"
              description="Alle getrackte Events je Key als Timeline."
              href="/key-visualization"
              cta="Verlauf öffnen"
              gridArea="4 / 1 / 5 / 4"
            />
            <BentoCard
              icon={Settings}
              title="Einstellungen"
              description="Sprache, Dark Mode, Export und mehr."
              href="/settings"
          ...
          <>
            ...
            <BentoCard icon={Settings} title="Einstellungen" description="Sprache, Dark Mode und mehr." gridArea="4 / 4 / 5 / 7" />
          </>
        )}
      </div>
    </main>
